...
- (void)viewDidLoad {
    ...
    if ([self.title isEqualToString:@"Line Chart"]) {
        ...
        [self.lineChart setXLabels:@[@"M 1",@"M 2",@"M 3",@"M 4",@"M 5",@"M 6",@"M 7"]];
    ...
    else if ([self.title isEqualToString:@"Bar Chart"])
    {
        ...
        [self.barChart setYValues:@[@10.0,@30.0,@10.0,@100.0,@500.0,@11.0,@14.0,@21.0]];
...
//        
//        
//        self. = [[PNCircleChart alloc] initWithFrame:CGRectMake(0,150.0, SCREEN_WIDTH, 100.0)
//                                                          total:@100
//                                                        current:@60
//                                                      clockwise:YES];
//        
